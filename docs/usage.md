...
1. [Introduction to Spherical Harmonics](../notebooks/01_intro_spherical_harmonics_with_pyshbundle.ipynb)
2. [Loadind Data](../notebooks/02_load_data.ipynb)
3. [Visualizations](../notebooks/03_visualizations.ipynb)
4. [Terrestrial Water Storage (TWS) Time Series](../notebooks/04_TWS_time_series.ipynb)
5. [Tests and Validation notebook](../notebooks/validation_pyshbundle.ipynb)
